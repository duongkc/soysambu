$(document).ready(function () {
    require([
        ...
        function generatePopupTitle(feature) {
            ...
            //title.className = 'd-flex flex-column ';
        ...
        function generatePopupContent(feature) {
            ...
            // Generate contents and append them to content container.
            content.append(generateAttributes(attributes));
            content.append(hr);
            content.append(generateChart(attributes));
